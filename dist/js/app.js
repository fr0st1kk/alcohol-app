(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".recomended__slider, .slider-thumb-product__slider, .slider-images-product__slider")) {
                new core(".recomended__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 4,
                ...
                new core(".slider-thumb-product__slider", {
                ...
                new core(".slider-images-product__slider", {
                    modules: [ Navigation, Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    ...
                    direction: "horizontal",
                    thumbs: {
                        swiper: ".slider-thumb-product__slider"
                    },
                    lazy: true,
                    navigation: {
                        prevEl: ".swiper-button-prev",
        ...
        da.init();
        const onLebels = document.querySelectorAll(".slide-recomended__on-leble");
        for (let i = 0; i < onLebels.length; i++) {
            const item = onLebels[i];
